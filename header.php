  ...
  <body>
    ...
    <!-- Navbar -->
      <nav class="navbar navbar-expand-lg" style="background: #ffe69a;">
        <div class="container">
          <a class="navbar-brand" href="beranda.php" style="color: black;text-shadow: 2px 2px 2px #3d6ebc;"><strong>PetsQu</strong></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link mr-4" href="beranda.php">BERANDA</a>
              </li>
              <li class="nav-item">
